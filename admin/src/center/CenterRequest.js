...
function CenterRequest() {
    ...
    function getCenters(page) {
        ...
        var url = `admin/center?page=${page}&limit=12&verify_status=pending`;
                                ...
                                <div className="col-xl-12">
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page">Centre Request</li>
                                        </ol>
                                    </nav>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <div className="form-group">
                                            ...
                                            >
                                                <option value="add">Filter By</option>
                    ...
                    <div className="center_list" id="filter-data">
                        <div className="row">
                            ...
                            centerData.map((data, key) => {
                                ...
                                return (
                                    <CenterCardCompoment key={key} request="pending" data={data} />
                                );
                            })
                    ...
                    {/* <nav aria-label="Page navigation example">
                                        <ul className="pagination justify-content-end">
                                            <li className={currentPage == 1 ?  'page-item disabled' : 'page-item'}>
                                                <a className="page-link" href="#" onClick={previewPage}>
                                                    Previous
                                                </a>
                                            </li>
                                            {
                                            ...
                                            <li className="page-item">
                                                <a className="page-link" onClick={e => changePage(first_page)}>
                                                    1
                                                </a>
                                            </li>
                                            <li className="page-item">
                                                <a className="page-link" onClick={e => changePage(2)}>
                                                    2
                                                </a>
                                            </li>
                                            <li className="page-item">
                                                <a className="page-link" onClick={e => changePage(3)}>
                                                    3
                                                </a>
                                            </li>
                                            <li className="page-item">
                                                <a className="page-link" onClick={e => changePage(last_page)}>
                                                    Next
                                                </a>
                                            </li>
                                        </ul>
