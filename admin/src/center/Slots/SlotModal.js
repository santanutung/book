...
function SlotModal(props) {
    const { setShowModal, getCurrentDateSlots, date, edit, setEdit, activeDate, centerId } = props
    ...
    function updateSlot() {
        ...
        axiosBaseUrl.put(url, { start_time: slot.start_time, end_time: slot.end_time, total_bed: slot.total_bed, repeat:slot.repeat, centerId:centerId })
            .then((res) => {
    ...
    function addSlot() {
        var data = { start_time: slot.start_time, end_time: slot.end_time, total_bed: slot.total_bed, date: moment(slot.date, 'DD/MM/YYYY').format('DD-MM-YYYY'), repeat:slot.repeat , centerId:centerId}
                                ...
                                <div className='col-md-6'>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            ...
                                            value={slot.start_time.replace(/^0+/, '')}
