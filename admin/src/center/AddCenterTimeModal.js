...
function AddCenterTimeModal(props) {

    const socket = useContext(SocketContext);
    const { setShowTimeModal, getCenterTime, id } = props
                ...
                if (result.isConfirmed) {
                    ...
                    axiosBaseUrl.post(`admin/center-time/${id}`, slot)
                        .then((res) => {
                            ...
                            socket.emit("center time", "hello");

                            // subscribe to socket events
                            // socket.on("center Time", () => {
                            //     alert("test")
                            //     getCenterTime()
                            // }); 
...
export default AddCenterTimeModal
