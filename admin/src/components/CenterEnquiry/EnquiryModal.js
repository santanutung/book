...
function EnquiryModal(props) {
    ...
    function updateEnquiry(e) {
        ...
        if (followUp == "") {
            ...
            axiosBaseUrl.post(`admin/center-enquiry/${editData._id}`, { message: followUp })
                .then((res) => {
    ...
    function getEnquiry() {
        axiosBaseUrl.get(`admin/center-enquiry/${editData._id}`)
            .then((res) => {
    ...
    function updateStatus(status) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axiosBaseUrl.put(`admin/center-enquiry/${editData._id}`, { status: status })
                    .then((res) => {
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className='row'>
                                ...
                                <div className='col-md-6'>
                                    <div className='form-group'>
                                        <strong>Phone Number :</strong> {enquiry.phone}
                                    </div>
                                </div>
                                <div className='col-md-6'>
                                    <div className='form-group'>
