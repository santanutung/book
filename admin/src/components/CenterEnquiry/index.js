...
function CenterEnquiry() {
    ...
    function getEnquiries(page, type = null) {
        ...
        var url = `admin/center-enquiry?limit=10&page=${page}&date=${search.date}&enquiry_no=${search.enquiry_no}`
        if(type == 'reset') {
            url = `admin/center-enquiry?limit=10&page=${page}`
        }
