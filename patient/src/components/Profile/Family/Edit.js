...
function Edit() {
    ...
    useEffect(() => {
      ...
      var data = location.state.family
        if (location.state.family.dob) {
            setProfileImage(location.state.family.profile_photo_path)

            data['day']= moment(location.state.family.dob).format('DD');
            data['month']= moment(location.state.family.dob).format('MM');
            data['year']= moment(location.state.family.dob).format('YYYY');
        }
    ...
    const add = (e) => {
        ...
        newData['reports'] = convertedFiles
        setAddData(newData)
        console.log(newData)
        ...
        if (Object.keys(error_data).length == 0) {
            ...
            axiosBaseUrl.put(`patients/api/edit-family/${addData._id}`, addData)
                .then((res) => {
                    // alert("estt")
                    console.log(res)
                    if (res.status == 200) {
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className='upload-img'>
                                                    ...
                                                    // src={addData.profile_photo_path ? addData.profile_photo_path : '/img/icon-upload.png'}
                                                    />
